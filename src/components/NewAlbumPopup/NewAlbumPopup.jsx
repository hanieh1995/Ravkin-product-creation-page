...
export default function NewAlbumPopup({ setOpenNewAlbumPopup }) {
    ...
    function addImage() {
        ...
        if (index != -1) {
            ...
            newArray.push({ url: allSizeImage[index], aspect: IMAGESIZES[index] });
    ...
    return (
        <div className="popup-main">
            <div className="newalbum-header">
                ...
                <div className={`next-btn ${allSizeImage.findIndex(img => img != "") != -1 && "active"}`}>Next</div>
            </div>
            ...
            {/* <ImageInformations/> */}
            <ImagesList allUploadedImages={allUploadedImages} setAllUploadedImages={setAllUploadedImages} />
